...
- AWS Cloud (ambiente de execução)
...
3. Treinamento automático do modelo utilizando ML no-code
4. Ajustes e re-treinamento para melhoria da performance
...
- Qualidade das previsões geradas

O SageMaker Canvas forneceu insights visuais que auxiliaram na interpretação dos resultados.
...
Os resultados indicam que o uso de Machine Learning pode contribuir significativamente para uma gestão de estoque mais eficiente.
